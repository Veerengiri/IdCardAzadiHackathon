...
const Artists = (props) => {
  ...
  const togglefilter=()=>{
    ...
    if(document.getElementById('hid-sec').style.display==="flex"){
      document.getElementById('hid-sec').style.display="none";
    }else{
      document.getElementById('hid-sec').style.display="flex";
    }
  }
  useEffect(() => {
    if (!islogin) {
      ...
      <div className="t-box">
        ...
        <div className="filter" id="filter">
          <div className="fil-title">
            ...
            <ArrowDropDownIcon onClick={togglefilter} id='arrowdownfil' />
            </IconButton>
          </div>
          <div
            className="hid-sec"
...
<div id="f-sort">
        ...
        <table>
          ...
          </tbody>: <div id="artload" style={{marginTop:'30px',width:'60vw',flex:1,display:'flex',justifyContent:'center',alignItems:'center',height:'350px'}} > <Loading/> </div>
          }
